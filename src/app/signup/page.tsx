        ...
        <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <button
              ...
              className={`w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${password.length < 6 || password !== confirmPassword ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${loading || password.length < 6 || password !== confirmPassword ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
              {loading ? (
                <>
